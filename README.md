...
[![Version](https://img.shields.io/badge/version-2.1.3-blue.svg)](https://github.com/TARS-snail/astrbot_plugin_self_recognition)
...
### v2.1.2
- 🐛 **修复对话管理器属性名错误**：修正 `conversationManager` 为 `conversation_manager`
